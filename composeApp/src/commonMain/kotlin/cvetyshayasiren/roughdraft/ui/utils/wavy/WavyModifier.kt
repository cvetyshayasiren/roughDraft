...
) = this then WavyElement(width, height, strokeWidth, color, start, end)
...
private data class WavyElement(
    ...
    override fun create(): WavyNode = WavyNode(width, height, strokeWidth, color, start, end)
